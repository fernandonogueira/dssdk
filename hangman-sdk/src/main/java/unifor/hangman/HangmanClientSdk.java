...
public class HangmanClientSdk {

    private DSSdk sdk;

    public HangmanClientSdk()
            throws InvalidConfigurationException, IOException {
        init();
    }

    private void init() throws InvalidConfigurationException, IOException {
        sdk = new SdkBuilder()
    ...
    public void sugerirLetra(String letra) throws IOException {
        DefaultMessage msg = new DefaultMessage();
        msg.setMethod("sugerirLetra");
        DefaultParam param = new DefaultParam();
        param.setName("letra");
        param.setValue(letra);
